...
export class AccountService {
    ...
    public async DepositValue(deposit: DepositDto): Promise<void> {
    ...
    private ValidateDepositObject(deposit: DepositDto): void {
